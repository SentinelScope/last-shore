...
export const ITEMS: Record<string, ItemDef> = {
  ...
  boot: {
    ...
    name: "Boot",
    type: "Found",
    description: "One boot. The sea had no use for the other.",
    stack: 1,
    tags: [],
  },
  gear: {
    ...
    name: "Gear",
    type: "Found",
    description: "A brass cog, green at the teeth. From something larger.",
    stack: 5,
    tags: [],
  },
  glowing_rod: {
    ...
    name: "Glowing Rod",
    type: "Found",
    description: "Faint light under the grit. Warm if you hold it too long.",
    stack: 1,
    tags: [],
  },
  wooden_spear: {
  ...
  stone_spear: {
    ...
    name: "Stone Spear",
    type: "Tool · durability",
    description: "A stone point lashed tight. Holds for thirty casts.",
    stack: 1,
    tags: [],
  },
  wooden_hammer: {
